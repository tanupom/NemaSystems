...
CurrentProfilejsonpath = r"/home/infinitysystem2/Documents/Infinity2.0Django_09122022/Pages/currentprofile.json"
...
def MainMenu_view(request, *args, **kwargs):
    ...
    if ((request.method == 'POST' and 'run_script' in request.POST)):
        ...
        curprofjsonpath = "/home/infinitysystem2/Documents/Infinity2.0Django_09122022/Pages/currentprofile.json"
        if request.user.is_authenticated:
            userss = {"user": request.user.username}
            usersss = {"Puser": userss,
                       }
        ...
        nikeshopen = open("/home/infinitysystem2/Documents/Infinity2.0Django_09122022/AssayLog4Chips.json")
        df = pd.DataFrame.from_dict(json.load(nikeshopen),orient="index")
        df = df.replace("true", u'\u2713')
        df = df.replace("false", nan)
        today = str(date.today())
        dailyexceldst = '/mnt/InternamDrive/Videos/Recorded Video/' + str(curprofname) + '/' + 'Data' + '/'
        dailyexcelsrc = r'/home/infinitysystem2/Documents/Infinity2.0Django_09122022/Pages/AssayLogOverviewTemplate.xlsx'
        ...
        if checkiffileexists == True:
            ...
            Detailedexcelpath = r'/media/infinitysystem2/InternamDrive/media/' + curprofname + '.xlsx'
        ...
        try:
            ...
            excelpath = '/media/infinitysystem2/InternamDrive/media/' + myfile
            os.rename(excelpath,)
            ...
            mediapath = '/media/infinitysystem2/InternamDrive/media'
            ...
            if os.path.isfile(myfilepath):
                ...
                curexcel = myfile
                excelprofilesjsonpath = "/home/infinitysystem2/Documents/Infinity2.0Django_09122022/Pages/allexcelprofiles.json"
...
#        try:
        ...
        updateJson()
        mediapath = r'/media/infinitysystem2/InternamDrive/media/'
        myfile = request.FILES['myfile']
        myfilepath = mediapath + '/' + str(myfile)
        fs = FileSystemStorage()
        if os.path.isfile(myfilepath):
       ...
       # print(request.POST['username'])
        ...
        print(headername)
        pathforcurrentprofileexceldatainmediafolder = "/media/infinitysystem2/InternamDrive/media/" + headername + ".xlsx"
        ...
        # try:
        pathforfilenameofselectedexcel = headernamemega
        pathforcurrentprofileexceldatainmediafolder = "/media/infinitysystem2/InternamDrive/media/" + headernamemega + ".xlsx"
        # os.rename(pathforfilenameofselectedexcel,pathforcurrentprofileexceldatainmediafolder)
        ...
        function_to_open_html_file = open(
            r'/home/infinitysystem2/Documents/Infinity2.0Django_09122022/Templates/Currentexcelprofile.html', 'w')
        ...
        currentprofilechipidsjsonpath = '/home/infinitysystem2/Documents/Infinity2.0Django_09122022/Pages/CurrentprofilechipIDs.json'
        ...
        for id in substrateidcolumn:
            ...
            print(chips)
        print("Printing")
        filenameJson = "/home/infinitysystem2/Documents/Infinity2.0Django_09122022/AssayLog4Chips.json"
        ...
        except NameError: number_of_active_presplit_videos = -1
...
#        with open(nikeshopen, "w") as w:
        ...
        curprofname = curprofprofiledata['clientcode'] + '_' + \
            curprofprofiledata['assaycode'] + \
            '_' + curprofprofiledata['biorep']
        videopath = '/mnt/InternamDrive/Videos/Recorded Video/'
        curprofnamenestpath = '/mnt/InternamDrive/Videos/Recorded Video/' + \
            str(curprofname) + '/'
        try:
        ...
        if (True):
            ...
            for filename in os.listdir("/mnt/InternamDrive/Videos/Recorded Video"):
                f = os.path.join(
                    "/mnt/InternamDrive/Videos/Recorded Video", filename)
                if os.path.isfile(f):
        ...
        try:
            ...
            path_to_presplit_videos = r'/media/infinitysystem2/InternamDrive/Videos/' + '/' + currentheadername + '/' + 'Pre-Split'
          #  global number_of_active_presplit_videos
            ...
            #number_of_active_presplit_videos = -1

#        variable0 = globaldatas[7]
       # variable0[0] = number_of_active_presplit_videos
       # globaldatas[7] = [variable0[0]]

        return render(request, "RunningAssayLive.html", globaldatas)
    ...
    # function to save all videos, should change to take in arguments later
        ...
        ProcessJson = "/home/infinitysystem2/Documents/Infinity2.0Django_09122022/Process.json"
        f = open(ProcessJson)
       ...
       # print(curprof,"Hello")
        ...
        strpassingtime = str(passinglength)
        CamerasSelected = "/home/infinitysystem2/Documents/Infinity2.0Django_09122022/SelectedCameras.json"
        f = open(CamerasSelected)
        CameraData = json.load(f)
        f.close()
        ChipsSelected = "/home/infinitysystem2/Documents/Infinity2.0Django_09122022/CurrentFourChips.json"
       ...
       # if(curprofprofiledata['tltimeinterval']=="Choose..." or curprofprofiledata['tltimeinterval']=="---"):
        ...
        cameraPath = "/home/infinitysystem2/Documents/Infinity2.0Django_09122022/SelectedCameras.json"
        chipPath = "/home/infinitysystem2/Documents/Infinity2.0Django_09122022/CurrentFourChips.json"
        ...
        curprofnamenestpath = '/media/infinitysystem2/InternamDrive/Videos/' + \
            str(curprofname) + '/'
        datas = {
            "CurrentProfile": curprofprofiledata,
            "headername": headernamemega,
        ...
        try:
            ...
            pass
        for filename in os.listdir("/media/infinitysystem2/InternamDrive/Videos/Recorded_Video"):
            try:
                f = os.path.join(
                    "/media/infinitysystem2/InternamDrive/Videos/Recorded_Video", filename)
                if os.path.isfile(f):
                    shutil.move(f, os.path.join(
